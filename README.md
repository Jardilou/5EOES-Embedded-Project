...
# 0.Preliminary Work
The very first step is to flash the unidentified firmware (see [Preliminary_Work/secure_sketch_v20251015.1.elf](#Preliminary_Work//secure_sketch_v20251015.1.elf)) on the arduino uno. 
